...
export default function SiteToolbar({ onSave, onExit, onUndo, onRedo, activeBreakpoint, onBreakpointChange, onRun, onStyles, isSiteStylesOpen, componentName, }: SiteToolbarProps): import("react/jsx-runtime").JSX.Element;
export {};
